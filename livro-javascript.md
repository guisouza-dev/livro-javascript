...
- [Comentar seu código JavaScript](#comentar-seu-codigo-javascript)
- [Declarar variáveis JavaScript](#declarar-variaveis-javascript)
- [Armazenar valores com o operador de atribuição](#armazenar-valores-com-o-operador-de-atribuicao)
- [Atribuir o valor de uma variável para outra](#atribuir-o-valor-de-uma-variavel-para-outra)
- [Inicializar variáveis com o operador de atribuição](#inicializar-variaveis-com-o-operador-de-atribuicao)
- [Declarar variáveis de string](#declarar-variaveis-de-string)
- [Entender variáveis não inicializadas](#entender-variaveis-nao-inicializadas)
- [Entender a sensibilidade a caracteres maiúsculos e minúsculos em variáveis](#entender-a-sensibilidade-a-caracteres-maiusculos-e-minusculos-em-variaveis)
- [Diferenciar entre as palavras-chave var e let](#diferenciar-entre-as-palavras-chave-var-e-let)
- [Declarar variáveis somente de leitura com a palavra-chave const](#declarar-variaveis-somente-de-leitura-com-a-palavra-chave-const)
- [Adicionar dois números com JavaScript](#adicionar-dois-numeros-com-javascript)
- [Subtrair um número de outro com JavaScript](#subtrair-um-numero-de-outro-com-javascript)
- [Multiplicar dois números com JavaScript](#multiplicar-dois-numeros-com-javascript)
- [Dividir um número por outro com JavaScript](#dividir-um-numero-por-outro-com-javascript)
- [Incrementar um número com JavaScript](#incrementar-um-numero-com-javascript)
- [Decrementar um número com JavaScript](#decrementar-um-numero-com-javascript)
- [Criar números decimais com JavaScript](#criar-numeros-decimais-com-javascript)
- [Multiplicar dois decimais com JavaScript](#multiplicar-dois-decimais-com-javascript)
- [Dividir um decimal por outro com JavaScript](#dividir-um-decimal-por-outro-com-javascript)
- [Descobrir o resto em JavaScript](#descobrir-o-resto-em-javascript)
- [Atribuir de modo composto com adição aumentada](#atribuir-de-modo-composto-com-adicao-aumentada)
- [Atribuir de modo composto com subtração aumentada](#atribuir-de-modo-composto-com-subtracao-aumentada)
- [Atribuir de modo composto com multiplicação aumentada](#atribuir-de-modo-composto-com-multiplicacao-aumentada)
- [Atribuir de modo composto com divisão aumentada](#atribuir-de-modo-composto-com-divisao-aumentada)
- [Escapar aspas literais em strings](#escapar-aspas-literais-em-strings)
- [Cercar uma string com aspas simples](#cercar-uma-string-com-aspas-simples)
- [Escapar sequências em strings](#escapar-sequencias-em-strings)
- [Concatenar strings com o operador mais](#concatenar-strings-com-o-operador-mais)
- [Concatenar strings com o operador mais igual](#concatenar-strings-com-o-operador-mais-igual)
- [Criar strings com variáveis](#criar-strings-com-variaveis)
- [Adicionar variáveis para strings](#adicionar-variaveis-para-strings)
- [Encontrar o tamanho de uma string](#encontrar-o-tamanho-de-uma-string)
- [Usar notação de colchetes para encontrar o primeiro caractere em uma string](#usar-notacao-de-colchetes-para-encontrar-o-primeiro-caractere-em-uma-string)
- [Entender a imutabilidade das strings](#estender-a-imutabilidade-das-strings)
- [Usar notação de colchetes para encontrar o enésimo caractere em uma string](#usar-notacao-de-colchetes-para-encontrar-o-enesimo-caractere-em-uma-string)
- [Usar notação de colchetes para encontrar o último caractere em uma string](#usar-notacao-de-colchetes-para-encontrar-o-ultimo-caractere-em-uma-string)
- [Usar notação de colchetes para descobrir o enésimo caractere antes do último em uma string](#usar-notacao-de-colchetes-para-descobrir-o-enesimo-caractere-antes-do-ultimo-em-uma-string)
- [Preencher espaços em branco](#preencher-espacos-em-branco)
- [Armazenar múltiplos valores em uma variável usando arrays JavaScript](#armazenar-multiplos-valores-em-uma-variavel-usando-arrays-javascript)
- [Aninhar um array em outro array](#aninhar-um-array-em-outro-array)
- [Acessar array de dados com índices](#acessar-array-de-dados-com-indices)
- [Modificar dados de array com índices](#modificar-dados-de-array-com-indices)
- [Acessar arrays multidimensionais com índices](#acessar-arrays-multidimensionais-com-indices)
- [Manipular arrays com push()](#manipular-arrays-com-push)
- [Manipular arrays com pop()](#manipular-arrays-com-pop)
- [Manipular arrays com shift()](#manipular-arrays-com-shift)
- [Manipular arrays com unshift()](#manipular-arrays-com-unshift)
- [Criar lista de compras](#criar-lista-de-compras)
- [Escrever JavaScript reutilizável com funções](#escrever-javascript-reutilizavel-com-funcoes)
- [Passar valores para funções com argumentos](#passar-valores-para-funcoes-com-argumentos)
- [Retornar um valor de uma função com return](#retornar-um-valor-de-uma-funcao-com-return)
- [Conhecer o escopo global e funções](#conhecer-o-escopo-global-e-funcoes)
- [Conhecer o escopo local e funções](#conhecer-o-escopo-local-e-funcoes)
- [Diferenciar escopo global e local em funções](#diferenciar-escopo-global-e-local-em-funcoes)
- [Entender o valor undefined retornado de uma função](#entender-o-valor-undefined-retornado-de-uma-funcao)
- [Atribuir com o valor retornado](#atribuir-com-valor-retornado)
- [Ficar na linha](#ficar-na-linha)
- [Entender valores booleanos](#entender-valores-booleanos)
- [Usar lógica condicional com instruções if](#usar-logica-condicional-com-instrucoes-if)
- [Comparar com o operador de igualdade](#comparar-com-o-operador-de-igualdade)
- [Comparar com o operador de igualdade estrita](#comparar-com-o-operador-de-igualdade-estrita)
- [Praticar a comparação de diferentes valores](#praticar-a-comparacao-de-diferentes-valores)
- [Comparar com o operador de desigualdade](#comparar-com-o-operador-de-desigualdade)
- [Comparar com o operador de desigualdade estrita](#comparar-com-o-operador-de-desigualdade-estrita)
- [Comparar com o operador maior que](#comparar-com-o-operador-maior-que)
- [Comparar com o operador maior ou igual](#comparar-com-o-operador-maior-ou-igual)
- [Comparar com o operador menor que](#comparar-com-o-operador-menor-que)
- [Comparar com o operador menor ou igual](#comparar-com-o-operador-menor-ou-igual)
- [Comparar com o operador lógico AND](#comparar-com-o-operador-logico-and)
- [Comparar com o operador lógico OR](#comparar-com-o-operador-logico-or)
- [Introduzir instruções else](#introduzir-instrucoes-else)
- [Introduzir instruções else if](#introduzir-instrucoes-else-if)
- [Usar a ordem lógica em instruções if else](#usar-a-ordem-logica-em-instrucoes-if-else)
- [Encadear instruções if else](#encadear-instrucoes-if-else)
- [Selecionar entre várias opções com instruções switch](#selecionar-entre-varias-opcoes-com-instrucoes-switch)
- [Adicionar uma opção padrão em instruções switch](#adicionar-uma-opcao-padrao-em-instrucoes-switch)
- [Lidar com várias opções idênticas em instruções switch](#lidar-com-opcoes-identicas-em-instrucoes-switch)
- [Substituir cadeias de if else por switch](#substituir-cadeias-de-if-else-por-switch)
- [Retornar valores booleanos das funções](#retornar-valores-booleanos-das-funcoes)
- [Retornar o padrão inicial para funções](#retornar-o-padrao-inicial-para-funcoes)
- [Criar objetos JavaScript](#criar-objetos-javascript)
- [Acessar propriedades de objetos com notação de pontos](#acessar-propriedades-de-objetos-com-notacao-de-pontos)
- [Acessar propriedades de objeto com notação de colchetes](#acessar-propriedades-de-objeto-com-notacao-de-colchetes)
- [Acessar propriedades de objetos com variáveis](#acessar-propriedades-de-objetos-com-variaveis)
- [Atualizar propriedades do objeto](#atualizar-propriedades-do-objeto)
- [Adicionar novas propriedades para um objeto JavaScript](#adicionar-novas-propriedades-para-um-objeto-javascript)
- [Excluir propriedades de um objeto JavaScript](#excluir-propriedades-de-um-objeto-javascript)
- [Usar objetos para pesquisas](#usar-objetos-para-pesquisas)
- [Testar objetos por propriedades](#testar-objetos-por-propriedades)
- [Manipular objetos complexos](#manipular-objetos-complexos)
- [Acessar objetos aninhados](#acessar-objetos-aninhados)
- [Acessar arrays aninhados](#acessar-arrays-aninhados)
- [Iterar com laços while em JavaScript](#iterar-com-lacos-while-em-javascript)
- [Iterar com laços for em JavaScript](#iterar-com-lacos-for-em-javascript)
- [Iterar números ímpares com um laço for](#iterar-numeros-impares-com-um-laco-for)
- [Contar para trás com um laço for](#contar-para-tras-com-um-laco-for)
- [Iterar através de um array com laço for](#iterar-atraves-de-um-array-com-laco-for)
- [Aninhar laços for](#aninhar-lacos-for)
- [Iterar com laços do...while em JavaScript](#iterar-com-lacos-dowhile-em-javascript)
- [Substituir laços usando recursão](#substituir-lacos-usando-recursao)
- [Gerar frações aleatórias com JavaScript](#gerar-fracoes-aleatorias-com-javascript)
- [Gerar números inteiros aleatórios com JavaScript](#gerar-numeros-inteiros-aleatorios-com-javascript)
- [Gerar números inteiros aleatórios dentro de um intervalo](#gerar-numeros-inteiros-aleatorios-dentro-de-um-intervalo)
- [Usar a função parseInt](#usar-a-funcao-parseint)
- [Usar a função parseInt com um radix](#usar-a-funcao-parseint-com-um-radix)
- [Usar o operador condicional (ternário)](#usar-o-operador-condicional-ternario)
- [Usar operadores de múltiplas condições (ternários)](#usar-operadores-de-multiplas-condicoes-ternarios)
